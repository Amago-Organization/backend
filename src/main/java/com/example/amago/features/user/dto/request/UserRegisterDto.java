...
public record UserRegisterDto(@NotBlank(groups = GroupValidation.Create.class) @Size(max = 255) String name,
                ...
                @NotBlank(groups = { GroupValidation.Create.class,
                                GroupValidation.Login.class }) @Size(min = 6, max = 10) @Pattern(regexp = RegexConstants.passwordAlfaNumericSpecialUpperLowerCase, message = ExceptionMessage.invalidPassword) String password) {
